...
export default function PresupuestoDetailsModal({ isOpen, onClose, presupuesto }) {
  ...
  const currentStatus = statusConfig[presupuesto.estado] || statusConfig.activo
        ...
        <div className="bg-white shadow-xl w-full max-w-6xl h-[90vh] flex flex-col overflow-hidden relative z-[101]">
          ...
          <div className="flex-shrink-0 flex items-center justify-between p-4 border-b bg-slate-800 text-white">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-semibold">Detalles de Presupuesto - {presupuesto.numero_presupuesto}</span>
            </div>
                    ...
                    <Card className="border border-slate-800">
                      <CardHeader>
                        <CardTitle className="flex items-center space-x-2">
                          ...
                          <span>Información del Presupuesto</span>
                        </CardTitle>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="flex justify-between">
                          <span className="text-sm text-gray-600">Número:</span>
                          <span className="font-mono font-medium">{presupuesto.numero_presupuesto}</span>
                        </div>
                        <div className="flex justify-between">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span>{presupuesto.usuario_nombre}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-sm text-gray-600">ID Presupuesto:</span>
                          <span className="font-mono text-sm">#{presupuesto.id}</span>
                        </div>
                        {presupuesto.tiene_cuenta_corriente && (
                          <div className="mt-4 p-3 bg-orange-50 border border-orange-200 rounded-lg">
                            ...
                            <p className="text-xs text-orange-700 mt-1">
                              Este presupuesto incluye pago con cuenta corriente
                            </p>
                          </div>
                        )}
                      </CardContent>
                    ...
                    <Card className="border border-slate-800">
                      ...
                      <CardContent className="space-y-4">
                        <div className="flex justify-between">
                          ...
                          <span className="font-medium">{presupuesto.cliente_nombre || "Cliente no especificado"}</span>
                        </div>
                        ...
                        {presupuesto.cliente_direccion && (
                          <div className="flex justify-between">
                            ...
                            <span className="text-right">{presupuesto.cliente_direccion}</span>
                          </div>
                        )}
                        {presupuesto.cliente_cuit && (
                          <div className="flex justify-between">
                            <span className="text-sm text-gray-600">CUIT:</span>
                            <span>{presupuesto.cliente_cuit}</span>
                          </div>
                        )}
                        {presupuesto.cliente_nombre === "Consumidor Final" && (
                          <div className="mt-3 p-2 bg-blue-50 border border-blue-200 rounded-lg">
                            <div className="flex items-center space-x-2">
                              ...
                              <span className="text-xs font-medium text-blue-800">Presupuesto Rápido</span>
                            </div>
                          </div>
                        )}
                      </CardContent>
                  ...
                  <Card className="border border-slate-800 mx-auto max-w-sm">
                    ...
                    <CardContent>
                      <div className="text-center">
                        <p className="text-3xl font-bold text-green-600">{formatCurrency(presupuesto.total)}</p>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border border-slate-800">
                    <CardHeader>
                      <CardTitle className="flex items-center space-x-2">
                        ...
                        <span>Productos Presupuestados ({presupuesto.detalles?.length || 0})</span>
                      </CardTitle>
                      <CardDescription>Detalle de productos incluidos en el presupuesto</CardDescription>
                    </CardHeader>
                    <CardContent>
                      {presupuesto.detalles && presupuesto.detalles.length > 0 ? (
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="text-muted-foreground">Este presupuesto no tiene productos registrados</p>
                        </div>
                      )}
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border border-slate-800">
                    <CardHeader>
                      <CardTitle className="flex items-center space-x-2">
                        ...
                        <span>Métodos de Pago ({presupuesto.pagos?.length || 0})</span>
                      </CardTitle>
                      <CardDescription>Detalle de los métodos de pago utilizados en el presupuesto</CardDescription>
                    </CardHeader>
                    <CardContent>
                      {presupuesto.pagos && presupuesto.pagos.length > 0 ? (
                        <div className="space-y-4">
                          {presupuesto.pagos.map((pago, index) => {
                          ...
                          <div className="border-t pt-4 mt-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                                <div className="flex justify-between items-center">
                                  ...
                                  <span className="font-bold text-xl text-blue-900">
                                    {formatCurrency(
                                      presupuesto.pagos.reduce((sum, pago) => sum + Number(pago.monto), 0),
                                    )}
                                  </span>
                                </div>
                              </div>
                              <div className="p-4 bg-green-50 rounded-lg border border-green-200">
                                <div className="flex justify-between items-center">
                                  <span className="font-medium text-green-700">Total Presupuesto:</span>
                        ...
                        <div className="text-center py-12">
                          ...
                          <p className="text-muted-foreground">
                            Este presupuesto no tiene información de pagos registrada
                          </p>
                        </div>
                      )}
                    </CardContent>
